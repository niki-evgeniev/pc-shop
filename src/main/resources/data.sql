...
INSERT INTO `models` (`id`, `category`, `brand_id`, `name`, created)
VALUES (1, 'LAPTOP', 1, 'TUF', '2023-11-19'),
       (2, 'LAPTOP', 1, 'ROG', '2023-11-19'),
       (3, 'COMPUTER', 1, 'ROG-PC', '2023-11-19'),
       (4, 'COMPUTER', 2, 'AORUS-PC', '2023-11-19'),
       (5, 'LAPTOP', 2, 'AORUS', '2023-11-19'),
       (6, 'LAPTOP', 3, 'MacBook', '2023-11-19'),
       (7, 'COMPUTER', 3, 'iMac-PC', '2023-11-19'),
       (8, 'LAPTOP', 4, 'Inspiron', '2023-11-19'),
